...
<body>
  ...
  <div class="container p-3 mt-4 border border-dark-subtle w-75 shadow-lg my-5">
    <i class="bi bi-door-open-fill me-1 fs-5"></i><span class="border-bottom border-success border-4 fs-4 fw-bold">RTO</span> <span class="fs-4 fw-semibold">Traffic Fine Portal</span><span class="text-light badge bg-success ms-1">Registration form</span>
    <c:if test="${succ != null}">
