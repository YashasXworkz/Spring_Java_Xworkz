...
<body>
  ...
  <div class="container p-3 mt-2 border border-dark-subtle w-75 shadow-lg">
    <i class="bi bi-door-open-fill me-1 fs-5"></i><span class="border-bottom border-primary border-4 fs-4 fw-bold">RTO</span> <span class="fs-4 fw-semibold">Traffic Fine Portal</span><span class="text-light badge bg-primary ms-1">Registraion form</span>
    <hr class="text-primary">
    <form action="save" method="post">
      <div class="row">
        <p class="fw-medium text-primary-emphasis">
          <i class="bi bi-file-person me-1"></i>Personal Details
        </p>
        <div class="col">
        ...
        <p class="fw-medium mt-2 text-primary-emphasis">
      ...
      <input type="submit" class="btn btn-primary w-100 mt-4 fw-bold rounded-0" value="Register">
    </form>
  </div>
</body>
</html>